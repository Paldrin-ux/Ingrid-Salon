...
@section('content_header')
    <div class="row mb-2 align-items-center">
        <div class="col-sm-6">
            <h1 class="m-0" style="font-weight: 600; color: #2c3e50;">All Users</h1>
        </div>
        <div class="col-sm-6">
            <div class="float-sm-right">
                ...
                <a href="{{ route('user.trash') }}" class="btn btn-sm" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a6f 100%); color: white; border: none; border-radius: 10px; padding: 10px 20px; font-weight: 500;">
                                        ...
                                        @foreach ($users as $user)
                                            <tr style="border-bottom: 1px solid #f0f0f0; transition: all 0.3s ease;">
                                                ...
                                                <td style="padding: 15px; vertical-align: middle; color: #6c757d; font-size: 0.9rem;">
                                                    <i class="far fa-envelope mr-1" style="color: #667eea;"></i>{{ $user->email }}
                                                </td>
                                                <td style="padding: 15px; vertical-align: middle; text-align: center;">
